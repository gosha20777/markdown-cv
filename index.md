...
- Основатель Open Source организации Lacmus Foundation (2018-настоящее время)
...
- Разработка искусственных нейронных сетей и систем компьютерного зрения для распознавания спутниковых и рендеринга карт (Python, C\C++)
...
- Продукты:
  - C# имплантация библиотеки компьютерного зрения Open CV
